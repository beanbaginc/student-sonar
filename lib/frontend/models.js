...
export class StudentProject extends Backbone.Model {}

export class StudentProjectSection extends Backbone.Model {
    parse(response, options) {
        return {
            name: response.name,
            id: response.id,
            tasks: new Backbone.Collection(response.tasks, {
...
export class StudentProjectCollection extends APICollection {
    constructor(models, options) {
        super(models, options);

        this.model = StudentProjectSection;
        this.url = '/api/student-projects';
    }
