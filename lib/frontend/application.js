...
export default class Application extends Backbone.Model {
    constructor(attributes, options) {
        ...
        this._proxyMigratedRoute(this._router, 'route:user');
        this._proxyMigratedRoute(this._router, 'route:calendar');
        this._proxyMigratedRoute(this._router, 'route:all-status-reports');
        this._proxyMigratedRoute(this._router, 'route:edit-status-report');
        this._proxyMigratedRoute(this._router, 'route:my-status-reports');
        this._proxyMigratedRoute(this._router, 'route:view-status-report');
        this._proxyMigratedRoute(this._router, 'route:projects');
        this._proxyMigratedRoute(this._router, 'route:project');
        this._proxyMigratedRoute(this._router, 'route:root');
        this._proxyMigratedRoute(this._router, 'route:users');
    }
