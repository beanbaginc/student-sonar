...
export default function() {
    ...
    proto.setAttribute = function(attribute, value) {
        if (attribute === 'student') {
            ...
            if (student.projects) {
                let $entry = $('<x-student-view-summary-entry/>')
                            .attr('title', 'Projects')
                            .appendTo(details);
                ...
                for (let project of student.projects) {
                    let $li = $('<li/>')
                        .appendTo($ul);
            ...
            if (student.status_reports) {
                let $entry = $('<x-student-view-summary-entry/>')
                    .attr('title', 'Status Reports')
                    .appendTo(details);

                let $statusReports = $('<ul/>')
                    .attr('id', 'status-reports')
                    .appendTo($entry);

                for (let report of student.status_reports) {
                    let $li = $('<li/>')
                        .appendTo($statusReports);
