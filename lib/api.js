...
export default function(options) {
    ...
    const resolvers = {
        ...
        Mutation: {
            saveStatusReport: async (root, { dateDue, id, text, user }, context) => {
                ...
                if (id === null) {
                    ...
                    if (updated !== 1) {
                        logging.error('Attempted to update StatusReport %d and updated %d rows',
                                      id, updated);
            ...
            saveStatusReportDueDate: async (root, obj, context) => {
                ...
                const groups = await schema.sql.Group.find({
                    where: {
        ...
        StatusReport: {
            ...
            dateSubmitted: obj => obj.dateSubmitted && obj.dateSubmitted.toISOString(),
