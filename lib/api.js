    ...
    const resolvers = {
        Query: {
            ...
            groups: (obj, args) => {
                ...
                return schema.Group.find(query, null, { sort: 'name' });
            },
            project: (obj, args) => asana.getTaskByID(args.id),
            projects: () => cache.memoize(asana.getTasks, 'student-projects', { json: true }),
        ...
        User: {
            ...
            projects: obj => {
                if (obj.projects.length) {
                    ...
                    return cache.memoize(asana.getTasks, 'student-projects', { json: true })
